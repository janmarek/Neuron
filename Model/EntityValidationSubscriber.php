 ...
 * @author Jan Marek
 */
class EntityValidationSubscriber implements \Doctrine\Common\EventSubscriber
{
	...
	private function validateEntity($entity) {
		...
		if (count($errors) > 0) {
			foreach ($errors as $violation) {
				throw new \Model\ValidationException($violation->getMessage(), $violation->getPropertyPath());
			}
		}
	}
}